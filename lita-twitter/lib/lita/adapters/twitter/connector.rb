          ...
          streaming_client.user do |object|
            ...
            when ::Twitter::Tweet
              ...
              if tweet.user.screen_name != robot.name
                ...
                message = if tweet.geo? && tweet.geo.instance_of?(::Twitter::Geo::Point)
                            Message.new(robot, text + '[' + tweet.geo.latitude.to_s + ',' + tweet.geo.longitude.to_s + ']', source)
                          else
                            Message.new(robot, text + '[51,-114]', source) #Hack, Assume City Hall if no geo location
                          end
            ...
            when ::Twitter::DirectMessage
              ...
              if dm.sender.screen_name != robot.name
                ...
                message = Message.new(robot, dm.text.dup + '[51,-114]', source)
                message.command!
                robot.receive(message)
              end
